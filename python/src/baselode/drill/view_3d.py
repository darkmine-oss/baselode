...
from baselode.datamodel import AZIMUTH, DIP, EASTING, HOLE_ID, NORTHING, ELEVATION
...
def structures_as_discs(structures, radius=2.0, color_by="defect"):
    ...
    - metadata: hole_id, depth, defect, dip, azimuth, comments
